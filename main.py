...
def faceDetect():
    eye_detect = False
    face_cascade = cv2.CascadeClassifier("Lee_Team_eye_blink/haarcascade_eye.xml") # 얼굴찾기 haar 파일
    eye_cascade = cv2.CascadeClassifier("Lee_Team_eye_blink/haarcascade_frontalface_default.xml") # 눈찾기 haar 파일
